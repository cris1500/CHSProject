...
public class Room1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        address = "00:21:13:04:1F:F7";//newint.getStringExtra(MainPanel.EXTRA_ADDRESS); //receive the address of the bluetooth device
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(Room1Activity.this, "Connecting...", "Please wait!");  //show a progress dialog
        }
